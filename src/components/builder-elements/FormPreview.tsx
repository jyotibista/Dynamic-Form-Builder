...
export default function FormPreview({ elements, layout }: FormPreviewProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        elements.forEach((element) => {
            ...
            } else if (element.pattern && typeof value === 'string' && !new RegExp(element.pattern).test(value)) {
    ...
    return (
        <Card className="mt-4">
            ...
            <CardContent>
                <form ref={formRef} onSubmit={handleSubmit} className={`grid gap-4 ${getGridClass()}`}>
